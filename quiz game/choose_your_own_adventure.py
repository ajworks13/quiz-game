...
answer = input(
    "You are ona dirt road, it has come to an end and you can go left or right. Which way would you like to go? ").lower()
...
if answer == "left":
    ...
    if answer == "back":
        ...
        answer = input(
            "You cross the brdige and meet a stranger. Do you talk to them? (yes/no) ")
